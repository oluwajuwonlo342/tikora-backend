...
export const register = async (req, res) => {
  try {
    ...
    // ✅ FIX: Map frontend "attendee" directly to database "user"
    let mappedRole = role;
    if (mappedRole === "attendee") {
      mappedRole = "user";
    }

    // ✅ FIX: Ensure the allowed roles match your database enum
    const allowedRoles = ["user", "organizer", "admin"];
    const userRole = allowedRoles.includes(mappedRole) ? mappedRole : "user";
